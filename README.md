...
**[💡 为什么要认识律师](./why-a-lawyer.md)** · **[📖 找律师实操手册](./find-a-lawyer.md)** · **[📊 裁判文书数据研究](./research/)**
...
**这份指南分三层**：机制与案例（为什么会丢）· [找律师实操手册](./find-a-lawyer.md)（丢了之后怎么办）· [裁判文书数据研究](./research/)（判断的依据从哪来）。
...
看懂机制只解决一半问题。真到了要维权那一步，多数人卡在同一个地方——**每个律师都说他行，但自己判断不出来**。

两篇，一篇讲为什么，一篇讲怎么做：

**→ [三十五岁后，我们需要认识律师](./why-a-lawyer.md)**

为什么这件事不该等到出事才开始：35 岁之后手上多出来的东西，风险大多在我们的专业能力之外；律师是分专业的，就像医生分科——这个道理我用大半年才换到。

**→ [找律师实操手册](./find-a-lawyer.md)**

七步流程，都是可以照着做的动作：建候选池的六个渠道各自的真实优劣、如何先确认对面是不是律师、用裁判文书网做尽调的十步法、面谈的四组必问问题、把报价换算成同口径总成本、合同里最贵的是"退出条款"、以及万一要换律师的分手顺序。

---

## 📊 裁判文书数据研究

案例是四个人的故事，数据是另一个视角。我们把某一类劳动争议近十年的裁判文书整体拉下来做了统计。

**→ [研究方法与全部数据](./research/)**（口径可复现，已知偏差逐条列明）

几条比较反直觉的结果：

- **检索命中数远不等于可参考的先例数。** 全文命中 1,576 篇，法院真正在裁判理由里展开论述的只有 510 篇（32.4%）；再去掉重复收录与串案，独立纠纷约 404 个。
- **约四分之一的一审案件是公司起诉员工**（公司对仲裁裁决不服）。因此"原告败诉"在这部分案件里意味着员工赢了——任何不区分原被告身份的胜诉率，方向可能是反的。
- **去重之前的地域排名完全不可信。** 有个省份靠一个 36 件的串案冲进前五，折叠后跌出前十；真实集中度是北上广合计过半。
- **有一条我们做不出来。** 试过三条路统计"员工胜诉率"，全部受阻，原因[逐条记录在此](./research/notes/outcome-blocked.md)。宁可留白，不写一个自己都验证不了的数字。
