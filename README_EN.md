...
- **Vested = yours**: Ilya Sutskever, an OpenAI co-founder, helped vote to remove the CEO in late 2023. He still walked away with his shares when he left in 2024; in 2026 court filings, he disclosed that OpenAI stake to be worth roughly **$7 billion**.
- **Fast correction**: In May 2024, OpenAI was caught with exit paperwork under which declining a non-disparagement agreement could cost you your *vested* equity (one researcher faced forfeiting ~$2M). After the outcry, the CEO apologized, promised nothing would ever be clawed back, and left the line **"vested equity is vested equity, full stop."** The clause was gone within days.
- **Early liquidity**: SpaceX runs tender offers roughly every six months; Stripe and OpenAI have done large-scale versions. ByteDance's periodic buybacks of pre-IPO employee shares follow the same playbook.
- **SV has its own traps**: the classic 90-day post-termination exercise window forces people to pay to exercise or forfeit — but Pinterest, Coinbase and others have extended it to 7–10 years.
